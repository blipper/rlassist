...
RLAssist_base_dir = 'data/network_inputs/RLAssist-seed-2030/'
...
with sqlite3.connect(iitk_db_path) as conn:
    ...
    for bin_id in range(5):
        ...
        for problem_id, test_programs_ in six.iteritems(bin_raw_test_data):
        ...
        for problem_id, test_programs_ in six.iteritems(bin_seeded_test_data):
